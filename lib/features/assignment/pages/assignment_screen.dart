...
import 'package:app_excle/features/assignment/pages/add_assignment_screen.dart';
      ...
      child: Scaffold(
            ...
            MethodStudentHelper.getCountOfSection(
              ...
              if (value >= 4) {
                SnackBarMessage.showQuickAlert(
                  message: "You Can Create more than 4 assignments",
                  context: context,
                ...
                NavigatorManager.navigateTo(
                  context: context,
                  page: AddAssignmentScreen(data: data),
                );
              }
            });
          },
        ...
        body: SafeArea(
          child: Column(
            ...
            children: [
              //body
              // BodyViewAssignment(data: data),
                  BaseBodyViewSectionSubject(
                baseIdDocsSubject: data.id!,
                nameCollectionSection: "assignments",
              ),
            ],
          ),
        ),
